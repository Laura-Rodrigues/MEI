...
## Details: https://towardsdatascience.com/reinforcement-learning-implement-grid-world-from-scratch-c5963765ebff
    ...
    def chooseAction(self):
        ...
        if np.random.uniform(0, 1) <= self.exp_rate: # exploration
            ...
            for a in self.actions:
                ...
                if self.deterministic:
                    nxt_reward = self.state_values[self.environment.nxtPosition(a)]
                else:
                    nxt_reward = None  ###### Complete !!
