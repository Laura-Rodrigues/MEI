...
class MLP:
    ...
    def __init__(self, dataset, hidden_nodes = 2, normalize = False):
        ...
        self.h = hidden_nodes
        print(f"\n\nnodes: {self.h}\n\n")
        self.W1 = np.zeros([hidden_nodes, self.X.shape[1]]) # [[0,0,...],[0,0,...]]
        self.W2 = np.zeros([1, hidden_nodes+1]) # [0,0,0]
        print(f"w1: {self.W1}\nw2: {self.W2}\n\n")
    ...
    def costFunction(self,weights): #, weights = None):
